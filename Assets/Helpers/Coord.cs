...
namespace Helpers
{
    public class Coord
    {
        ...
        public static implicit operator Coord((int x, int y) t) { return new Coord(t.x, t.y); }
        public static implicit operator (int, int)(Coord c) { return (c.x, c.y); }
        ...
        public static Coord Random(Coord min, Coord max) => new Coord(new System.Random().Next(min.x, max.x), new System.Random().Next(min.y, max.y));
